...
public class Portal
{
    ...
    public static Sprite getFgAnimationSprite(int index)
    {
        ...
        if (portalFgAnimationSprites[index] == null)
            portalFgAnimationSprites[index] = loadSpriteFromResources($"TheOtherRoles.Resources.PortalAnimation.portal_{index:000}.png", 115f);
    ...
    public static void startTeleport(byte playerId, byte exit)
    {
        ...
        // Generate log info
        PlayerControl playerControl = playerById(playerId);
