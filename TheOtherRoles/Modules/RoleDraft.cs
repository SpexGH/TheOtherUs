                    ...
                    if (PlayerControl.LocalPlayer.PlayerId == pickOrder[0]) {
                        ...
                        foreach (RoleInfo roleInfo in RoleInfo.allRoleInfos) {
                            ...
                            if (PlayerControl.LocalPlayer.Data.Role.IsImpostor) {
                                int impsMax = GameOptionsManager.Instance.currentNormalGameOptions.NumImpostors;
                                int impsMin = 0;
                        ...
                        if (availableRoles.Count == 0) {
                            ...
                            Warn("Draft Mode: Fallback triggered, because no roles were left. Forced addition of basegame Imp/Crewmate");
                        }
