            ...
            foreach (PlayerControl player in CachedPlayer.AllPlayers)
            {
                ...
                if (Disperser.dispersesToVent)
                    CachedPlayer.LocalPlayer.PlayerControl.transform.position =
                        FindVentPoss()[rnd.Next(FindVentPoss().Count)];
                else
                    switch (GameOptionsManager.Instance.currentNormalGameOptions.MapId)
                    {
                        case 0:
                            CachedPlayer.LocalPlayer.PlayerControl.transform.position =
                                skeldSpawn[rnd.Next(skeldSpawn.Count)];
                            break;
                        case 1:
                            CachedPlayer.LocalPlayer.PlayerControl.transform.position =
                                miraSpawn[rnd.Next(miraSpawn.Count)];
                            break;
                        case 2:
                            CachedPlayer.LocalPlayer.PlayerControl.transform.position =
                                polusSpawn[rnd.Next(polusSpawn.Count)];
                            break;
                        case 3:
                            CachedPlayer.LocalPlayer.PlayerControl.transform.position =
                                dleksSpawn[rnd.Next(dleksSpawn.Count)];
                            break;
                        case 4:
                            CachedPlayer.LocalPlayer.PlayerControl.transform.position =
                        ...
                        case 5:
                            CachedPlayer.LocalPlayer.PlayerControl.transform.position =
                                fungleSpawn[rnd.Next(fungleSpawn.Count)];
                            break;
                    }
            }
