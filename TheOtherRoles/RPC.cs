        ...
        public static void setModifier(byte modifierId, byte playerId, byte flag) {
            ...
            switch ((RoleId)modifierId) {
                ...
                case RoleId.PhantomAbility:
                    PhantomAbility.phantomAbility = player;
                    break;
                case RoleId.Bait:
    ...
    public static void amnisiacTakeRole(byte targetId) {
        ...
        PlayerControl amnisiac = Amnisiac.amnisiac;
            ...
            switch((RoleId)roleInfo.roleId) {
                ...
                case RoleId.Madmate:
                    if (Amnisiac.resetRole) Madmate.clearAndReload();
                    Madmate.madmate = amnisiac;
                    Amnisiac.clearAndReload();
                    break;
            ...
            // Never reload Sheriff
                ...
                case RoleId.DoorHacker:
                    Helpers.turnToImpostor(Amnisiac.amnisiac);
                    if (Amnisiac.resetRole) DoorHacker.clearAndReload();
                    Amnisiac.clearAndReload();
                    break;
...
/*
        ...
        public static void erasePlayerRoles(byte playerId, bool ignoreModifier = true) {
            ...
            if (player == PhantomRole.phantomRole) PhantomRole.clearAndReload();
            ...
            if (player == Guesser.niceGuesser) Guesser.clearAndReload(); //clear(player.PlayerId);
        ...
        public static void giveBomb(byte playerId) {
            ...
            FastDestroyableSingleton<HudManager>.Instance.StartCoroutine(Effects.Lerp(Bomber.bombDelay + Bomber.bombTimer, new Action<float>((p) => { // Delayed action
				if (!Helpers.isAlive(Bomber.hasBomb)) return;
    ...
    public static void showCultistFlash() {
        if (Follower.follower  == CachedPlayer.LocalPlayer.PlayerControl) {
            Helpers.showFlash(Trapper.color, 1f); }
    }
        ...
        static void Postfix([HarmonyArgument(0)]byte callId, [HarmonyArgument(1)]MessageReader reader)
        {
            ...
            switch (packetId) {
                ...
                case (byte)CustomRPC.JackalCreatesSidekick:
                    ...
                    break;
                case (byte)CustomRPC.TurnToPhantom:
                    RPCProcedure.turntoPhantom(reader.ReadByte());
                    break;
