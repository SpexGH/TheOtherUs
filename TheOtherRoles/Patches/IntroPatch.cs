    ...
    class IntroCutsceneOnDestroyPatch
    {
        ...
        public static void Prefix(IntroCutscene __instance) {
            ...
            if (AmongUsClient.Instance.AmHost && TORMapOptions.shieldFirstKill && TORMapOptions.firstKillName != "" && !HideNSeek.isHideNSeekGM && !PropHunt.isPropHuntGM) {
                var target = PlayerControl.AllPlayerControls.ToArray().ToList().FirstOrDefault(x => x.Data.PlayerName.Equals(TORMapOptions.firstKillName));
                if (target != null) {
        ...
        public static void setupIntroTeam(IntroCutscene __instance, ref  Il2CppSystem.Collections.Generic.List<PlayerControl> yourTeam) {
            ...
            if (roleInfo.isNeutral) {
               ...
               __instance.BackgroundBar.material.color = roleInfo.color;
                ...
                bool isCrew = !(roleInfo.color == Palette.ImpostorRed);
                if (isCrew) {
                    __instance.BackgroundBar.material.color = roleInfo.color;
