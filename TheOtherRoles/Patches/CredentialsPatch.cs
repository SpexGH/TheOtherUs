...
namespace TheOtherRoles.Patches {
    ...
    public static class CredentialsPatch {
        ...
        public static string fullCredentials        = $"<size=130%><color={terColor}>The Epic Roles</color></size> <size=50%>v{TheOtherRolesPlugin.Version.ToString()}\nRemodded by <color={terColor}>operr</color>";
        public static string mainMenuCredentials    = $"Remodded by <color={terColor}>operr</color>";
        public static string torCredentials         = $"<size=40%><color={torColor}>Original Mod by github.com/LaicosVK/TheEpicRoles</color></size>";
        ...
        public static class LogoPatch
        {
            ...
            public static void loadSprites()
            {
                ...
                if (horseBannerSprite == null) horseBannerSprite = Helpers.loadSpriteFromResources("TheOtherRoles.Resources.BannerHorse.png", 300f);
            }
