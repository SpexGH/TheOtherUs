                ...
                () => {
                    ...
                    if (murderAttemptResult == MurderAttemptResult.PerformKill) {
                        ...
                        if ((Sheriff.currentTarget.Data.Role.IsImpostor && (Sheriff.currentTarget != Mini.mini || Mini.isGrownUp())) ||
                            ...
                            (Madmate.madmate == Sheriff.currentTarget) ||
      ...
      //              SoundEffectsManager.play("shifterShift");
            ...
            securityGuardButton = new CustomButton(
                ...
                () => {
                    ...
                    return PlayerControl.GameOptions.MapId != 1 && SecurityGuard.remainingScrews >= SecurityGuard.camPrice && CachedPlayer.LocalPlayer.PlayerControl.CanMove;
                },
                () => { securityGuardButton.Timer = securityGuardButton.MaxTimer; },
           ...
           if (Blackmailer.blackmailed != null) text = Blackmailer.blackmailed.Data.PlayerName;
            ...
            cultistTurnButton = new CustomButton(
                ...
                () => { 
                    showTargetNameOnButton(Cultist.currentTarget, cultistTurnButton, ""); // Show now text since the button already says sidekick
            ...
            changeChatButton = new CustomButton(
                ...
                () => { 
                    ...
                    return true; },
                () => { return; },
                Helpers.loadSpriteFromResources("TheOtherRoles.Resources.LoversChat.png", 150f),  // Invisible button!
