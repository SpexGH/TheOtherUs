...
/*
        ...
        disperserChargesText = Object.Instantiate(disperserDisperseButton.actionButton.cooldownTimerText,
            disperserDisperseButton.actionButton.cooldownTimerText.transform.parent);
        ...
        jackalSidekickButton = new CustomButton(
            ...
            () =>
            {
                showTargetNameOnButton(Jackal.currentTarget, jackalSidekickButton,
        ...
        werewolfKillButton = new CustomButton(
            ...
            () =>
            {
                showTargetNameOnButton(Werewolf.currentTarget, werewolfKillButton, "KILL");
