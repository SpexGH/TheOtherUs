...
namespace TheOtherRoles
{
    class RoleInfo {
		...
		public static RoleInfo swooper = new RoleInfo("Swooper", Swooper.color, "Turn Invisible and kill everyone", "Turn Invisible", RoleId.Swooper, true);
        ...
        public static RoleInfo follower = new RoleInfo("Follower", Cleaner.color, "Follow your leader", "Follow your leader", RoleId.Follower, true);
        public static RoleInfo phantomRole = new RoleInfo("Phantom", PhantomRole.color, "Complete all your tasks without being caught!", "Complete all your tasks without being caught!", RoleId.PhantomRole, true);
        ...
        public static RoleInfo escapist = new RoleInfo("Escapist", Escapist.color, "Get away from kills with ease", "Teleport to get away from bodies", RoleId.Escapist);
        ...
        public static RoleInfo radar  = new RoleInfo("Radar", Color.yellow, "Be on high alert", "Be on high alert", RoleId.Radar, false, true);
        ...
        public static RoleInfo phantomAbility = new RoleInfo("Phantom", PhantomRole.color, "Complete all your tasks without being caught!", "Complete all your tasks without being caught!", RoleId.PhantomAbility, false, true);
        ...
        public static List<RoleInfo> getRoleInfoForPlayer(PlayerControl p, bool showModifier = true, bool onlyMods = false) {
            ...
            if (p == PhantomRole.phantomRole) infos.Add(phantomRole);
