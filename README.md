...
|  Mafioso(Mafia)  |   Jester   |        Mayor        |    Torch     |
|  Janitor(Mafia)  |  Vulture   |     Portalmaker     |  Sunglasses  |
|    Morphling     |   Lawyer   |      Engineer       |     Bait     |
|      Bomber      | Prosecutor | PrivateInvestigator |    Flash     |
|     Poucher      |  Pursuer   |       Sheriff       |    Bloody    |
|      Mimic       |   Jackal   |       Deputy        | AntiTeleport |
|   Camouflager    |  Sidekick  |      BodyGuard      |  Tiebreaker  |
|      Eraser      |  Swooper   |       Lighter       | Multitasker  |
...
| ------------------ | ----------- | ------------------------------------------------------------ |
| 2024.3.5 ~ 2024.6.4 | v1.3.8     | [Download](https://github.com/SpexGH/TheOtherUs/releases/download/v1.3.8/TheOtherUs.zip) |
| 2024.3.5 ~ 2024.6.4 | v1.3.7     | [Download](https://github.com/SpexGH/TheOtherUs/releases/download/v1.3.7/TheOtherUs.zip) |
| 2024.3.5 ~ 2024.6.4 | v1.3.6     | [Download](https://github.com/SpexGH/TheOtherUs/releases/download/v1.3.6/TheOtherUs.zip) |
| 2024.3.5 ~ 2024.6.4 | v1.3.5     | [Download](https://github.com/SpexGH/TheOtherUs/releases/download/v1.3.5/TheOtherUs.zip) |
